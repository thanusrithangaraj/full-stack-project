...
<body>
    ...
    <div class="container big-deal">
        <div class="image">
            <img src="./img/service" alt="bigdeal">
        </div>
        <div class="services">
            <div class="heading">
                <h4>OUR SERVICES</h4>
    ...
    <div class="container testimonial py-5">
        ...
        <div class="testimonial-parent">
            <div class="testimonial-card">
                ...
                <p class="testimonial-name">Sushma</p>
                ...
                I stumbled upon BLUSH ND GLOW during my search for effective skincare solutions, 
                and I'm so glad I did! Their products have worked wonders on my skin, delivering noticeable results in 
                just a few weeks. 
                </p>
            ...
            <div class="testimonial-card">
                ...
                <p class="testimonial-name">Sarikaa</p>

                <p class="testimonial-title">CFO & Financial Implications</p>

                <img src="./img/quotes.svg" alt="quotation" class="quotation-img" width="26">

                <p class="testimonial-desc">
                Their wide selection of shades and expert advice helped me find the ideal foundation and lipstick 
                colors that enhance my natural beauty. 
                I'm thrilled with the results and can't wait to explore more of their products!
                </p>
            ...
            <div class="testimonial-card">
                ...
                <p class="testimonial-name">Kiruthika</p>

                <p class="testimonial-title">CMO & Branding Advertising</p>

                <img src="./img/quotes.svg" alt="quotation" class="quotation-img" width="26">

                <p class="testimonial-desc">
                Whether I'm looking for a luxurious skincare treatment or a trendy makeup palette,
                I know I can count on [Cosmetic Shop's Name] to deliver excellence every time.
